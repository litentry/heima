...
deploy_contracts() {
    ...
    if [ -f "$BROADCAST_FILE" ]; then
        ...
        echo "# AA Contract Addresses - Generated by docker-deploy.sh" > "$OUTPUT_FILE"
        echo "OE_ENTRY_POINT_ADDRESS=$ENTRYPOINT_ADDRESS" >> "$OUTPUT_FILE"
        echo "OE_OMNI_FACTORY_ADDRESS=$FACTORY_ADDRESS" >> "$OUTPUT_FILE"
        echo "OE_OMNI_WALLET_IMPLEMENTATION_ADDRESS=0x0000000000000000000000000000000000000000" >> "$OUTPUT_FILE"
