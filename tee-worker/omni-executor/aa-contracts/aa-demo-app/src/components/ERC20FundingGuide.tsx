                        ...
                        <div>
                            ...
                            <div className="space-y-2">
                                {walletTokenBalances.map((tb) => (
                                    <div
                                        key={tb.symbol}
                                        className={`p-3 rounded-lg flex justify-between items-center ${tb.symbol === "USDC" ? "bg-blue-50" : "bg-green-50"
                                            }`}
                                    >
                                        ...
                                        <div className="flex items-center gap-2">
                                            ...
                                            {tb.balance > BigInt(0) ? (
                                                <button
                                                    ...
                                                    className={`px-3 py-1 text-white text-sm rounded-md transition-colors disabled:opacity-50 ${tb.symbol === "USDC"
