        ...
        <div className="w-full max-w-md mx-auto p-6 bg-white rounded-lg shadow-lg">
            ...
            <div className="flex mb-6 bg-gray-100 rounded-lg p-1">
                <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeWallet === 'evm'
                ...
                <button
                    ...
                    className={`flex-1 py-2 px-4 rounded-md text-sm font-medium transition-colors ${activeWallet === 'solana'
                            ? 'bg-white text-gray-900 shadow-sm'
                            : 'text-gray-500 hover:text-gray-700'
                        }`}
                >
