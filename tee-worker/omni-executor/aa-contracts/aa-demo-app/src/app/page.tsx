...
function HomeContent() {
  ...
  const fetchEthBalance = useCallback(async () => {
    ...
    try {
      ...
      console.log('Fetched balance:', balance.toString(), 'for address:', aaWalletAddress)
    } catch (error) {
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="bg-white rounded-lg shadow-lg p-6 sticky top-8">
              ...
              <div className="mt-8 p-4 bg-purple-50 border border-purple-200 rounded-lg">
                <h3 className="font-medium text-purple-800 mb-2">Demo Features</h3>
          ...
          <div className="lg:col-span-2">
            <div className="space-y-8">
              ...
              {currentStep === 1 && (
                <div>
                  ...
                  <p className="text-gray-600 mb-6">
                    Connect your EVM wallet (MetaMask, etc.) or Solana wallet (Phantom, etc.) to get started.
                  </p>
                  <WalletConnect />
                </div>
              )}
              ...
              {currentStep >= 2 && (
                <div>
                  <h2 className="text-xl font-semibold mb-4">Step 2: View Your Smart Account</h2>
                  <p className="text-gray-600 mb-6">
                    Your Smart Account address is pre-calculated using your wallet address and client ID.
                  </p>
              ...
              {currentStep >= 3 && currentStep <= 3 && (
                <div>
                  <h2 className="text-xl font-semibold mb-4">Step 3: Fund Your Smart Account</h2>
                  <p className="text-gray-600 mb-6">
                    Send some ETH to your Smart Account address to enable Account Abstraction features.
                  </p>
                  <FundingGuide 
              ...
              {currentStep >= 4 && currentStep <= 4 && (
                <div>
                  <h2 className="text-xl font-semibold mb-4">Step 4: Authorize Root Key</h2>
                  <p className="text-gray-600 mb-6">
                    Set up a root signer that can create sessions and delegate access to your Smart Account.
                  </p>
              ...
              {currentStep >= 5 && (
                <div>
                  <h2 className="text-xl font-semibold mb-4">Step 5: Start Swapping</h2>
                  <p className="text-gray-600 mb-6">
                    Your Smart Account is ready! Send swap requests to the TEE worker service.
                  </p>
                  <SwapInterface isAuthorized={isAuthorized} />
                </div>
              )}
                  ...
                  <div className="bg-white rounded-lg shadow p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-green-700">Smart Account Funded</span>
                      </div>
                      <span className="text-sm text-gray-500">
                  ...
                  <div className="bg-white rounded-lg shadow p-4">
                    <div className="flex items-center justify-between">
                      <div className="flex items-center space-x-3">
                        ...
                        <span className="font-medium text-green-700">Root Key Authorized</span>
                      </div>
                      <span className="text-sm text-gray-500">Ready for swaps</span>
                    </div>
                  </div>
                )}
              </div>
