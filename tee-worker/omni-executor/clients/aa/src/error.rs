...
impl From<oe_client_ethereum::RpcProviderError> for AaContractError {
	fn from(err: oe_client_ethereum::RpcProviderError) -> Self {
		match err {
			...
			oe_client_ethereum::RpcProviderError::JsonRpc { code, message, .. } => {
