...
const DEFAULT_MAILER_FROM_NAME: &str = "PumpX Verify";
const DEFAULT_GOOGLE_CLIENT_ID: &str = "";
const DEFAULT_GOOGLE_CLIENT_SECRET: &str = "";
const DEFAULT_PARENTCHAIN_URL: &str = "wss://default.parentchain.node";
const DEFAULT_ETHEREUM_URL: &str = "https://eth-mainnet.default.com/v2/";
const DEFAULT_SOLANA_URL: &str = "https://api.mainnet-beta.solana.default.com";
const DEFAULT_BSC_URL: &str = "https://bsc-mainnet.default.com";
const DEFAULT_BSC_TESTNET_URL: &str = ""; // Optional
const DEFAULT_PUMPX_API_BASE_URL: &str = "https://api.pumpx.ai";
const DEFAULT_PUMPX_SIGNER_URL: &str = "https://signer.pumpx.ai";
const DEFAULT_PUMPX_WORKER_URL: &str = "https://worker.pumpx.ai";
