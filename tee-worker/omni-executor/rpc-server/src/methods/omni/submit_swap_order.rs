...
use pumpx::constants::*;
use pumpx::pumpx_types::common::SwapType;
use pumpx::pumpx_types::create_market_order_tx::CreateMarketOrderTxResponse;
use pumpx::pumpx_types::order_info::{OrderInfoResponse, OrderInfoResponseData};
use serde::Serialize;
...
pub fn register_submit_swap_order(module: &mut RpcModule<RpcContext>) {
	module
		.register_async_method("omni_submitSwapOrder", |params, ctx, _| async move {
			...
			log::debug!("Received omni_submitSwapOrder, user_email: {}, intent_id: {}, order_type: {:?}, swap_type: {:?}, from_chain_id: {}, from_token_ca: {:?}, from_amount: {}, to_chain_id: {}, to_token_ca: {:?}, wallet_index: {}",
			...
			log::debug!("Calling pumpx get_user_trade_info, user_email: {}", params.user_email);
			let user_trade_info =
