...
const PUMPX_API_CREATE_TRANSFER_UNSIGNED_TX_FAILED_CODE: i32 = -32015;
const PUMPX_API_SEND_TRANSFER_TX_FAILED_CODE: i32 = -32016;

const PUMPX_SIGNER_REQUEST_SIGNATURE_FAILED_CODE: i32 = -32100;
