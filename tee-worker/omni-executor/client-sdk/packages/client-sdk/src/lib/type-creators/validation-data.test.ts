...
describe('Bitcoin', () => {
  test('0x prefix is restored for hex encoded challenge code', () => {
    const validationData = createLitentryValidationDataType(
      ...
      {
        message: 'a7960fc417cc24e9346c36cba74bf43a1fac66d1c2eacb474e56343f09e8340ac',
        signature: 'H7+Fq/aqJsFSbKQvwalp9+Nju7+eTnvxgqV47QGOdlDWMiqJpDPSa2zYSdpeIXcqWclaNPUYtcxviCJ/StMN6vQ=',
      },
    );
    ...
    expect(data.message.toHuman()).toEqual('0xa7960fc417cc24e9346c36cba74bf43a1fac66d1c2eacb474e56343f09e8340ac');
    expect(data.signature.isBitcoin).toBeTruthy();
    expect(
      data.signature.asBitcoin.eq(
        base64Decode('H7+Fq/aqJsFSbKQvwalp9+Nju7+eTnvxgqV47QGOdlDWMiqJpDPSa2zYSdpeIXcqWclaNPUYtcxviCJ/StMN6vQ='),
      ),
    ).toBeTruthy();
  });
  ...
  test('utf-8 challenge codes are preserved as is', () => {
    const validationData = createLitentryValidationDataType(
      ...
      {
        message: 'Token: 0xa7960fc417cc24e9346c36cba74bf43a1fac66d1c2eacb474e56343f09e8340ac',
        signature: 'H7+Fq/aqJsFSbKQvwalp9+Nju7+eTnvxgqV47QGOdlDWMiqJpDPSa2zYSdpeIXcqWclaNPUYtcxviCJ/StMN6vQ=',
      },
    );
...
describe('Solana', () => {
  test('it works', () => {
    const validationData = createLitentryValidationDataType(
      ...
      {
        message: 'hello world',
        signature: '2Z6GoT1BTNSfEj8WgtY8cozEVzwBFYqbcyCDStVs1AV3HTmQrD2k92VTiqVRC1rPcMBkaBwL9ytkbe21RS18ycjn',
      },
    );
  ...
  test('it works with hex encoded signatures', () => {
    ...
    expect(validationData.isWeb3Validation).toBeTruthy();
    expect(validationData.asWeb3Validation.isSolana).toBeTruthy();
    expect(validationData.asWeb3Validation.asSolana.message.toHuman()).toEqual('hello world');
    expect(validationData.asWeb3Validation.asSolana.signature.isEd25519).toBeTruthy();
    expect(validationData.asWeb3Validation.asSolana.signature.asEd25519.toHex()).toEqual(
      '0x3c5d36a76ed33902bd7b44a0fc6d194ae1599ff17064716c1e3808c4eb69aa84756084ca117641da629cb9159606655f41e5816a10f3e4df8d9019e8bb112009',
    );
  });
});
...
describe('Twitter', () => {
  test('it works', () => {
    ...
    expect(validationData.asWeb2Validation.asTwitter.isPublicTweet).toBeTruthy();

    const data = validationData.asWeb2Validation.asTwitter.asPublicTweet;
    expect(data.tweet_id.toHuman()).toEqual('https://twitter.com/0x123/status/123');
  });
...
describe('Discord', () => {
  test('it works', () => {
    ...
    expect(validationData.asWeb2Validation.asDiscord.isPublicMessage).toBeTruthy();
