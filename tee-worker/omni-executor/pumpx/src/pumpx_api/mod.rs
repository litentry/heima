...
use methods::post_heima_login::{post_heima_login_impl, PostHeimaLoginResponse};
...
impl PumpxApi for PumpxApiClient {
	...
	async fn post_heima_login(
		...
		post_heima_login_impl(self, access_token, body).await
	}
}
...
pub mod mocks {
	...
	use crate::methods::post_heima_login::PostHeimaLoginBody;
	use crate::methods::post_heima_login::PostHeimaLoginResponse;
