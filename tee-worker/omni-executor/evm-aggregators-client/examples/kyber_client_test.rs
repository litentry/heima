...
pub async fn main() {
	...
	let kyber_client = KyberClient::new("dummy_secret_key", "https://aggregator-api.kyberswap.com");
	...
	let swap_route_response = kyber_client.get_swap_route(56, swap_route_request).await.unwrap();
	...
	let swap_response = kyber_client.swap(56, swap_request).await.unwrap();
