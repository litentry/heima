...
use executor_primitives::{utils::hex::decode_hex, ChainId, Identity};
...
impl<EthereumIntentExecutor: IntentExecutor, SolanaIntentExecutor: IntentExecutor>
...
>(
	ctx: Arc<TaskHandlerContext<EthereumIntentExecutor, SolanaIntentExecutor>>,
	...
	match wrapper.task {
		...
		NativeTask::RequestIntent(omni_account, intent_id, _intent) => {
			...
			// All intents temporarily rejected
