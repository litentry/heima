...
const QUOTING_ENCLAVE_CERTIFICATE_CHAIN: &[u8; 1891] = include_bytes!(
	"../../../primitives/src/teebag/sgx_verify/test/dcap/qe_identity_issuer_chain.pem"
);
...
const TCB_CERTIFICATE_CHAIN: &[u8; 1891] =
	include_bytes!("../../../primitives/src/teebag/sgx_verify/test/dcap/tcb_info_issuer_chain.pem");
