...
impl<T: frame_system::Config> pallet_scheduler::WeightInfo for WeightInfo<T> {
	...
	fn service_agenda_base(s: u32, ) -> Weight {
		...
		Weight::from_parts(5_168_764, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 2_556
			.saturating_add(Weight::from_parts(759_809, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	...
	fn schedule(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_277_285, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 3_583
			.saturating_add(Weight::from_parts(837_979, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
	}
	/// Storage: `Scheduler::Agenda` (r:1 w:1)
	...
	fn cancel(s: u32, ) -> Weight {
		...
		Weight::from_parts(13_867_362, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 5_568
			.saturating_add(Weight::from_parts(1_440_531, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	...
	fn schedule_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_945_472, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 4_963
			.saturating_add(Weight::from_parts(898_730, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	/// Storage: `Scheduler::Lookup` (r:1 w:1)
	...
	fn cancel_named(s: u32, ) -> Weight {
		...
		Weight::from_parts(16_463_690, 0)
			.saturating_add(Weight::from_parts(0, 42428))
			// Standard Error: 6_940
			.saturating_add(Weight::from_parts(1_474_679, 0).saturating_mul(s.into()))
			.saturating_add(T::DbWeight::get().reads(2))
			.saturating_add(T::DbWeight::get().writes(2))
	}
	fn schedule_retry(_: u32) -> Weight { todo!() }
	fn set_retry() -> Weight { todo!() }
	fn set_retry_named() -> Weight { todo!() }
	fn cancel_retry() -> Weight { todo!() }
	fn cancel_retry_named() -> Weight { todo!() }
}
