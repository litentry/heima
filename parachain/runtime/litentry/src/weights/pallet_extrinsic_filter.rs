...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(10_227_524, 0)
			.saturating_add(Weight::from_parts(0, 3607))
			// Standard Error: 34
			.saturating_add(Weight::from_parts(2_755, 0).saturating_mul(p.into()))
			// Standard Error: 34
			.saturating_add(Weight::from_parts(2_799, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(11_970_730, 0)
			.saturating_add(Weight::from_parts(0, 3644))
			// Standard Error: 56
			.saturating_add(Weight::from_parts(10_658, 0).saturating_mul(p.into()))
			// Standard Error: 56
			.saturating_add(Weight::from_parts(10_694, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
