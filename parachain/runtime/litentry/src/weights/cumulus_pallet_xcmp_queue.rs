...
impl<T: frame_system::Config> cumulus_pallet_xcmp_queue::WeightInfo for WeightInfo<T> {
	...
	fn enqueue_xcmp_message() -> Weight { todo!() }
	fn suspend_channel() -> Weight { todo!() }
	fn resume_channel() -> Weight { todo!() }
	fn take_first_concatenated_xcm() -> Weight { todo!() }
	fn on_idle_good_msg() -> Weight { todo!() }
	fn on_idle_large_msg() -> Weight { todo!() }
}
