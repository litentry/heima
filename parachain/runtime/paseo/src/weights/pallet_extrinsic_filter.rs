...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(25_306_744, 0)
			.saturating_add(Weight::from_parts(0, 3607))
			// Standard Error: 39
			.saturating_add(Weight::from_parts(4_381, 0).saturating_mul(p.into()))
			// Standard Error: 39
			.saturating_add(Weight::from_parts(4_055, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(27_857_933, 0)
			.saturating_add(Weight::from_parts(0, 3644))
			// Standard Error: 58
			.saturating_add(Weight::from_parts(17_491, 0).saturating_mul(p.into()))
			// Standard Error: 58
			.saturating_add(Weight::from_parts(16_713, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
