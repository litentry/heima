...
impl<T: frame_system::Config> pallet_extrinsic_filter::WeightInfo for WeightInfo<T> {
	...
	fn block_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(10_293_747, 0)
			.saturating_add(Weight::from_parts(0, 3607))
			// Standard Error: 46
			.saturating_add(Weight::from_parts(2_918, 0).saturating_mul(p.into()))
			// Standard Error: 46
			.saturating_add(Weight::from_parts(2_809, 0).saturating_mul(f.into()))
	...
	fn unblock_extrinsics(p: u32, f: u32, ) -> Weight {
		...
		Weight::from_parts(10_929_962, 0)
			.saturating_add(Weight::from_parts(0, 3644))
			// Standard Error: 115
			.saturating_add(Weight::from_parts(10_966, 0).saturating_mul(p.into()))
			// Standard Error: 115
			.saturating_add(Weight::from_parts(11_428, 0).saturating_mul(f.into()))
			.saturating_add(T::DbWeight::get().reads(1))
			.saturating_add(T::DbWeight::get().writes(1))
